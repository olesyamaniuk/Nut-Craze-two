document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".q-q-navigation-list");
  const headerRef = document.querySelector(".q-q-header");
  const navigationRef = document.querySelector(".q-q-navigation");
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".q-q-toggle-button img");
